...
export default function ServicesGrid() {
  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute left-0 top-1/2 -z-10 h-96 w-96 rounded-full bg-agency-coral/10 blur-3xl" />
      ...
      >
        <div>
          <div
            data-reveal-item
            className="mb-4 inline-flex items-center gap-2 rounded-full border border-agency-coral/30 bg-agency-coral/10 px-3 py-1 font-mono text-xs text-agency-coral-light"
          >
          ...
          >
            Production <span className="text-agency-coral italic">Capabilities</span>.
          </h2>
        </div>
        <p
          data-reveal-item
          className="max-w-md font-sans text-sm leading-relaxed text-agency-muted"
        >
            ...
            return (
              <motion.button
                ...
                className={`group relative w-full overflow-hidden rounded-xl border p-6 text-left will-change-transform ${
                  isActive
                    ? "border-agency-coral/50 bg-agency-surface shadow-[0_0_20px_rgba(255,107,53,0.15)]"
                    : "border-agency-border bg-agency-surface/30 hover:border-agency-border-coral hover:bg-agency-surface/50"
                }`}
              >
                {isActive && (
                  <motion.div
                    layoutId={reduceMotion ? undefined : "active-service-bar"}
                    className="absolute bottom-0 left-0 top-0 w-1 bg-agency-coral"
                ...
                <div className="mb-2 flex items-center justify-between">
                  <span
                    className={`font-mono text-xs transition-colors ${
                      isActive ? "font-bold text-agency-coral-light" : "text-agency-muted"
                    }`}
                  >
                  ...
                  <ArrowUpRight
                    className={`h-4 w-4 transition-transform duration-300 ${
                      isActive
                        ? "rotate-45 text-agency-coral"
                        : "text-agency-muted group-hover:text-agency-white"
                    }`}
                  />
                </div>
                ...
                <p className="mt-2 line-clamp-2 font-sans text-xs leading-relaxed text-agency-muted">
                  {service.tagline}
                </p>
              </motion.button>
            );
            ...
            >
              <div className="relative mb-8 aspect-[16/9] w-full overflow-hidden rounded-xl border border-agency-border">
                ...
                <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between">
                  <span className="rounded border border-agency-border bg-agency-black/90 px-3 py-1 font-mono text-[11px] text-agency-coral-light">
              ...
              <div>
                <div className="mb-2 flex items-center gap-2">
                  <span className="font-mono text-xs text-agency-coral">
                    {activeService.number}
                  </span>
                  <span className="font-mono text-xs uppercase text-agency-muted">
                ...
                <p className="mb-6 font-sans text-sm leading-relaxed text-agency-muted sm:text-base">
                  {activeService.description}
                </p>

                <div className="mb-6">
                  <h4 className="mb-3 font-mono text-[11px] uppercase tracking-wider text-agency-muted">
                    [ CORE DELIVERABLES ]
                  </h4>
                ...
                <div className="mb-8 rounded-xl border border-agency-border bg-agency-black/60 p-4">
                  <span className="mb-2 block font-mono text-[10px] uppercase tracking-wider text-agency-coral-light">
                  ...
                  <ul className="space-y-1.5 font-sans text-xs text-agency-white/80">
                    {activeService.clientWorks.slice(0, 3).map((client, i) => (
                      <li key={i} className="flex items-center gap-2">
                        <CheckCircle2 className="h-3.5 w-3.5 flex-shrink-0 text-agency-coral" />
                        <span>{client}</span>
                      </li>
                    ))}
                  </ul>
              ...
              <div className="flex items-center justify-between border-t border-agency-border pt-6">
                <Link
                  href="/services"
                  className="inline-flex items-center gap-2 font-mono text-xs uppercase tracking-wider text-agency-coral hover:underline"
                >
                ...
                <Link
                  ...
                  className="rounded-full bg-agency-coral px-5 py-2.5 font-display text-xs font-bold uppercase tracking-wider text-agency-black transition-colors hover:bg-agency-coral-hover"
                >
                  Inquire
                </Link>
              </div>
      ...
      <div className="mt-16 flex flex-col justify-between gap-4 border-t border-agency-border pt-8 font-mono text-xs text-agency-muted sm:flex-row sm:items-center">
        ...
        <Link
          href="/services"
          className="inline-flex items-center gap-2 rounded-full border border-agency-border-coral bg-agency-surface px-6 py-3 font-semibold text-agency-coral transition-all hover:bg-agency-coral hover:text-agency-black"
        >
